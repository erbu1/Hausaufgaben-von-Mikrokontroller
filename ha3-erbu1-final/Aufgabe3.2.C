...
//
//-------------------------------------------Tımer Konfiguration-----------------------------------
    TB0CTL = MC_1+ TBSSEL_2+ ID_3;   //timer start, takt quelle ist smclk und divider ist 8
    TB0EX0 = TBIDEX_4;               //zusatzlich dividiere takt zu 5
    TB0CCR0 = 0xffff;                //zahlt bis 0xffff
//-------------------->>>>>>>>>>>>>>>>>>>> etwa 2.6 sekunden dauert ein Runde
//-------------------------------------------------------------------------------------------------
...
// NOTE: led  reagiert sofort sobald taster s2 gedruckt ist, weil wir keine softwaredelay verwenden 
